...
class BlocksMap {
  ...
  //blockinfo保存数据节点的信息都是在datanode启动时上报的，是动态构建的。
  //namenode启动时内存中保存的关于数据块的信息由block类维护。
  //namenode维护的对应关系随着datanode不断上报数据块信息更新blockinfo
