...
public class CorruptReplicasMap{
  ...
  public static enum Reason {
    ...
    GENSTAMP_MISMATCH,   // mismatch in generation stamps 时间戳不一致
    SIZE_MISMATCH,       // mismatch in sizes datanode上副本大小与namenode上数据块大小不一致
    INVALID_STATE,       // invalid state 无效状态
    CORRUPTION_REPORTED  // client or datanode reported the corruption 客户端或者数据节点汇报
  }
